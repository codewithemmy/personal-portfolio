        ...
        <div className="row">
          <div className="col-12">
            <div className="skill-bx ">
              ...
              <p>
                {" "}
                I am a problem-solver, with a can-do attitude. I aim for success
                right from the start of anything<br></br> I am also efficient
                anywhere i find myself. I have pratical skills like;
              </p>
              <Carousel
              ...
              >
                ...
                <div className="item">
                  <img src={graphQlImage} alt="Image" />
                  <h5>GraphQL</h5>
                </div>
                <div className="item">
                ...
                <div className="item">
                  <img src={microserviceImage} alt="Image" />
                  <h5>MicroService & Monolith</h5>
                </div>
                <div className="item">
                  <img src={redisImage} alt="Image" />
                  <h5>Redis</h5>
                </div>
                <div className="item">
